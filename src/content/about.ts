...
export const PARAGRAPHS: string[] = [
  ...
  "I studied CS and Human-Computer Interaction at CU Boulder, spent five years as a software engineer at Warner Bros. and DirecTV, and recently earned a Master's in AI at UT Austin - each step deepening a humanist and technically grounded approach to neural networks.",
  "Outside work, I'm often skiing, mountain biking, mountaineering (ask me about climbing mountains!). Big cook, bigger music nerd.",
];
