...
export function ThemeProvider({ 
  ...
  // - server can't read prefers-color-scheme, render 'initialTheme'
  // - post-hydration: read the media query, correct once.
  //   (no better solutions besides injecting a script in the head or rerendering the app)
  useEffect(() => {
